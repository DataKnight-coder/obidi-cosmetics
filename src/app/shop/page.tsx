...
export const metadata = {
  ...
  description: "Browse authentic makeup, skincare, hair care and fragrance curated by OBIDI COSMETICS.",
};
      ...
      <main className="pb-24">
        <section className="section-shell py-12 sm:py-20">
          <div className="rounded-[2rem] bg-[#211017] px-7 py-14 text-white sm:px-12 sm:py-20 lg:rounded-[3rem] lg:px-20">
            <p className="eyebrow text-[#e5bd78]">The full OBIDI edit</p>
        ...
        <section className="section-shell py-10 sm:py-16">
          ...
          {products.length > 0 ? (
            ...
            <div className="editorial-card rounded-[2rem] px-6 py-20 text-center">
              ...
              <p className="mt-3 text-on-surface-variant">Check back soon for the next OBIDI edit.</p>
            </div>
          )}
        </section>
      </main>
